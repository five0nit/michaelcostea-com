...
<rect class="side-rail" x="34" y="116" width="10" height="184" fill="{accent}"/>
<text class="micro-label side-label" x="58" y="314">{lab[:34]}</text>
...
"""
    ...
    if "premium-deck-refresh-20260630e" not in src:
        premium_css = """
/* premium-deck-refresh-20260630e: stronger generated-art quality pass */
...
"""
    ...
    if "contrast-fix-20260630b" not in src:
        contrast_css = """
/* contrast-fix-20260630b: no pale cyan-on-paper text or clipped side labels inside generated panels */
...
"""
    ...
    if "global-min-text-20260630a" not in src:
        min_text_css = """
/* global-min-text-20260630a: deck-wide minimum readable text size, not agenda-only */

...
for(const url of ['https://michaelcostea.com/','https://michaelcostea.com/ai-automation-scope-proposal-kit.html','https://michaelcostea.com/freelancer-client-admin-starter-kit.html',guideUrl,'https://michaelcostea.com/guides/freelance-invoice-follow-up-email/','https://michaelcostea.com/safe-walk-away-agent-kit.html']) if(!sitemap.includes(`<loc>${url}</loc>`)) throw new Error(`sitemap missing ${url}`);

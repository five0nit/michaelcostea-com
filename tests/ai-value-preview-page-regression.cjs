...
if (!indexText.includes('MICHAEL COSTEA I BUILD AI EMPLOYEES TO RUN THE BUSINESS WITH YOU.')) {
  throw new Error('main index.html should contain the approved agent-operations headline');
}

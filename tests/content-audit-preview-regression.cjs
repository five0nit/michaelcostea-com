...
must(previewHtml.includes('preview/content-audit/preview.css?v=20260711-agentic-pass-3'), 'preview stylesheet missing');

const homeText = text('#readerWindow');
for (const phrase of [
  'OPERATIONS, SYSTEMS & AI AGENTS',
  '352 stores',
  '5,000+ staff',
  'Licensed electrician',
  'Proof before promises',
  'Agentic systems, not just prompts',
  '25 visible agents',
  'Orchestration',
  'Memory & continuity',
  'Permissions & review',
...
must(preview.querySelectorAll('#readerWindow .agentic-practice-grid article').length === 4, 'homepage should show four agentic operating disciplines');
...
for (const phrase of ['What I Own Now', 'Selected Evidence', 'Agentic Systems Practice', 'Agent architecture', 'Autonomous operations', 'Human governance', 'AgentMesh', '352', '5,000+', '500,000', '74%']) {
